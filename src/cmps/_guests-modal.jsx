...
export class GuestsCheckoutModal extends React.Component {
    ...
    render() {
        const { onSelectGuests, toggleGuestsModal, trip, stay } = this.props
                ...
                {trip && <div className="guest-modal-container flex column">
                    ...
                    <div className="guest-card flex space-between  align-center">
                        ...
                        <div className="guest-amount">
                            ...
                            <p className="guest-amount-count">{adults}</p>
                    ...
                    <div className="guest-card flex space-between align-center">
                        ...
                        <div className="guest-amount">
                            ...
                            <p className="guest-amount-count">{kids}</p>
                    ...
                    <div className="guest-card flex space-between  align-center">
                        ...
                        <div className="guest-amount ">
                            ...
                            <p className="guest-amount-count">{infants}</p>
